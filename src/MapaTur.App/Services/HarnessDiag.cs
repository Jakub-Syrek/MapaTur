    ...
    private static void WriteStatus()
    {
        try
        {
            ...
            var status = new
            {
                ...
                glPoolMB = GlTrack.PoolFreeBytes / (1024 * 1024),
                glPoolHit = GlTrack.PoolHits,
                glPoolMiss = GlTrack.PoolMisses,
                pboWaits = GlTrack.PboFenceWaits,
                draws = GlTrack.Draws,
                genTex = GlTrack.TexGenTotal,
                delTex = GlTrack.TexDelTotal,
                genBuf = GlTrack.BufGenTotal,
                delBuf = GlTrack.BufDelTotal,
                upDet05MB = GlTrack.UpDet05 / (1024 * 1024),
                upDet25MB = GlTrack.UpDet25 / (1024 * 1024),
                upOrthoMB = GlTrack.UpOrtho / (1024 * 1024),
                upMaskMB = GlTrack.UpMask / (1024 * 1024),
                upMeshMB = GlTrack.UpMesh / (1024 * 1024),
